...
get_subject_tnt_data = function(folder,.pb=NULL){
	...
	msgs = msgs[trialData$msgNum:length(msgs)]
	...
	table(temp$word)
	trialData = bind_cols(trialData,temp)
	table(trialData$string_time-trialData$word_time)
